...
const products = [
    {
        ...
        fullDescription: "Experience an incredible boost in facial elasticity. Revive dry, tired skin with deep hydration and lasting firmness—even in harsh weather. This rich yet powerful formula deeply hydrates your skin, restoring its firmness and leaving it feeling refreshed with long-lasting suppleness.",
    ...
    },
    {
        ...
        fullDescription: "A lightweight gel-cream formula that deeply replenishes moisture, building a strong hydration barrier. Cool down skin heat and boost up hydration! Restores the skin's oil-water balance, calming dry, rough skin for a dewy and healthy glow.",
        features: [
                    ...
                    <div class="product-detail-content" id="detail-content-${product.id}">
                        ...
                        <div class="price-notice">
                            <div class="notice-content">
                                ${product.id === 1 ? `
                                    <p><span style="display: block; text-align: center;">▶REMEMBER◀</span><br>This price is <span class="discount-highlight">30% DISCOUNTED</span> from the current international market price.</p>
                                ...
                                ` : `
                                    <p><span style="display: block; text-align: center;">▶REMEMBER◀</span><br>This exclusive product is HARD TO FIND on the international market.</p>
                                    <div class="compare-link">
                                        <a href="https://www.oliveyoung.co.kr/store/goods/getGoodsDetail.do?goodsNo=A000000167170&t_page=%ED%86%B5%ED%95%A9%EA%B2%80%EC%83%89%EA%B2%B0%EA%B3%BC%ED%8E%98%EC%9D%B4%EC%A7%80&t_click=%EA%B2%80%EC%83%89%EC%83%81%ED%92%88%EC%83%81%EC%84%B8&t_search_name=CNP&t_number=12&dispCatNo=1000001000100150001&trackingCd=Result_11_30" 
                                           target="_blank" 
                                           class="market-link">
